...
import { SkalaProductos } from "../constants";
        ...
        {SkalaProductos.map((producto, index) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <a
                href={`https://wa.me/5353118193?text=Estoy%20interesado%20en%20la%20camiseta%20de%20${encodeURIComponent(
                  producto.nombre
